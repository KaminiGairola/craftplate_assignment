      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            IconButton(
              icon: Icon(Icons.edit,color: Color(0XFF93999F),),
              onPressed: () {},
            ),
          ],
        ),
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                      color: isSelected ? Color(0XFF912018): Colors.grey, // Dynamic border color
                                      width: 2,
                                    ),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        "Non Veg",
                                        style: TextStyle(
                                          color: isSelected ? Color(0XFF912018) : Color(0xFF912018), // Dynamic text color
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>FillDetailsScreen()));
                      },
